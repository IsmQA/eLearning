...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Library</h1>
        ...
        {{-- <div class="container-fluid"> --}}
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="/addLibrary/{{$library->id}}"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group" id="link_input" style="display: none">
                            ...
                            <input type="url" class="form-control" name="link" <?php if($library->tipe == 3){ echo 'value="'.$library->file.'"';} ?>>
                        </div>
                        @if ($library->tipe != 3)
                            <a href="{{URL::to('library/'.$library->file)}}" target="_blank">{{$library->file}}</a> | <label><input type="checkbox" value="true" name="cek"> Ganti</label>
                            <br>  
                        @else
                            <a href="{{$library->file}}" target="_blank">{{$library->file}}</a> | <label><input type="checkbox" value="true" name="cek"> Ganti</label>
                            <br>
                        @endif
