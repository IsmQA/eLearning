    ...
    <div class="container-fluid">
        ...
        {{-- <div class="container-fluid"> --}}
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="/editSoal/{{$id}}/{{$soal->id}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="waktu" value="{{$soal->waktu}}" placeholder="Dalam menit ..." required>
                          </div>
